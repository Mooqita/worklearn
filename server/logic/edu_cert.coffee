...
@gen_cert_template = (user) ->
	...
	res = store_document_unprotected EduCertTemplate, template
...
@gen_cert_recipient = (issuer, template, recipient_mail) ->
	...
	res = store_document_unprotected EduCertRecipients, recipient
...
@gen_cert_assertion = (recipient, user) ->
	...
	store_document_unprotected EduCertAssertions, assertion_item
